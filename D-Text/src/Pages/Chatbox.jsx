    ...
    return (
        <>
            ...
            <div className='chatBody'>
                ...
                <div className="message-outer-left"><div className='message-left'><p>D-TEXT Bot</p>Welcome! Before sending messages or adding members to this group please note :<br /> 1. Once a member added can't be removed <br />2. Once a message sent can't be edited or deleted.</div></div>
