...
function Main() {
    ...
    window.ethereum && ethereum.on('chainChanged', (_chainId) => {
        window.location.reload();
        loadUserAccount();
    }
    );
    ...
    return (
        <>
            <MainContext.Provider value={{ provider, setProvider, web3, setWeb3, contract, userAccount, loadWeb3, loadUserAccount }}>
                <Navbar />
                <Outlet />
                <Footer />
